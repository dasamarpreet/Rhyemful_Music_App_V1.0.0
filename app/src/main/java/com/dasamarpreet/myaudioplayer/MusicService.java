...
import static com.dasamarpreet.myaudioplayer.NowPlayingFragmentBottom.gifImageView;
import static com.dasamarpreet.myaudioplayer.PlayerTestingNew.listSongs;
...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener {
    ...
    static MediaPlayer mediaPlayerid;
    ...
    private void playMedia(int StartPosition) {
        ...
        if (mediaPlayerid != null){
            ...
            if (musicFiles != null){
                ...
                mediaPlayerid.start();
                gifImageView.setBackgroundResource(R.drawable.equalizer);
            }
        }
        else {
            createMediaPlayer(StartPosition);
    ...
    boolean isPlaying(){
        return mediaPlayerid.isPlaying();
    }
    ...
    int getDuration(){
        return mediaPlayerid.getDuration();
    }

    void seekTo(int position){
        mediaPlayerid.seekTo(position);
    }

    int getCurrentPosition(){
        return mediaPlayerid.getCurrentPosition();
    }

    void createMediaPlayer(int positionInner){
        position = positionInner;
        uri = Uri.parse(musicFiles.get(positionInner).getPath());
        ...
        editor.apply();
        mediaPlayerid = MediaPlayer.create(getBaseContext(), uri);
    }

    void pause(){
        mediaPlayerid.pause();
        gifImageView.setBackgroundResource(R.drawable.pause_gif2);
    }

    void OnCompleted(){
        mediaPlayerid.setOnCompletionListener(this);
    }
    ...
    void showNotification(int playPauseBtn){
        Intent intent = new Intent(this, PlayerTestingNew.class);
        ...
        if (picture != null){
            ...
            thumb = BitmapFactory.decodeResource(getResources(), R.drawable.logo_variant_no_bg);
        }
